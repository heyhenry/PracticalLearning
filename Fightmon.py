    ...
    if ready == 'yes':
        ...
        if ans == 'yes':
            ...
            while coinLoop:
                ...
                # if user input does not match coinflipList,
                # it will return to the beginning of while loop (coinLoop)
        ...
        # responses other than yes or no will return to the beginning of the aforementioned question
        else:
            print("Invalid response! System shutdown initiated.")
            print("Boom, crash, dead.")
            break
